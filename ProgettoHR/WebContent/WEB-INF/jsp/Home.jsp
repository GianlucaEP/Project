...
<body>
    ...
    <div class="row w-100 p-0 m-0">
        <nav class="navbar navbar-light fixed-top bg-primary w-100" style="opacity: 0.8;">
            ...
            <!-- Bottone profilo -->
            <button class="btn btn-primary dropdown-toggle" role="button" id="userOptions" data-toggle="dropdown"
    ...
    <div style="margin-top: 110px;" class="container-fluid">
        <div class="row h-100">
            <div class="col-auto p-0 bg-primary" style="opacity: 0.9; border-radius: 1px 10px 10px 1px;">

                <!-- bottone aggiunta candidato-->
                <a href="/ProgettoHR/Candidati/${businessUnit}" type="button"
                    class="btn btn-primary btn-block mt-1 text-left">+ Candidato <i class="fas fa-user"></i></a>

                <!-- bottone aggiunta mansione -->
                <button class="btn btn-primary btn-block m-0 text-left" data-toggle="modal"
            ...
            <!-- Tabella principale -->
            <div class="col-md-2 col-lg-10 p-0 justify-content-md-center table-responsive-md">
                <table class="table table-striped text-center table-hover shadow p-4 ml-3 mb-4 bg-white">
                    ...
                    <tbody>
                        <c:forEach var="cand" items="${list}">
                            <tr>
                                <td>
                                    <c:choose>
                                        <c:when test="${ cand.stato.descrizione == 'attivo'}">
                                            <span id="dot" data-toggle="tooltip" data-placement="top" title="Attivo"
                                        ...
                                        <c:when test="${ cand.stato.descrizione == 'scartato'}">
                                            <span id="dot" data-toggle="tooltip" data-placement="top" title="Scartato"
                                ...
                                <td onclick="window.location = '/ProgettoHR/Candidato/${cand.id}'">
                                ...
                                <td>
                                    <c:forEach var="area" items="${cand.area}">
                                        <span onclick="window.location = '/ProgettoHR/Candidato/${cand.id}'">
                                            ${area.area}</span>
                                    </c:forEach>
                                </td>

                                <td>
                                    <c:forEach var="mansione" items="${cand.mansione}">
                                        <span onclick="window.location = '/ProgettoHR/Candidato/${cand.id}'">
                                ...
                                <td data-toggle="modal" data-target="#EliminaModal"><i class="fas fa-trash-alt"></i>
                                </td>
                            </tr>
                            <!-- The Modal -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button onclick="window.location = '/ProgettoHR/Elimina/${cand.id}'"
                                                type="button" class="btn btn-success" data-dismiss="modal">Si</button>
                                            <button onclick="window.location = '/ProgettoHR/Home'" type="button"
                                                class="btn btn-danger" data-dismiss="modal">No</button>
                                        </div>
    ...
    <div class="modal fade" id="mansioneModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
