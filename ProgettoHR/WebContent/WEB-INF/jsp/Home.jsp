...
<body onload="validateOption()">
            ...
            <nav class="navbar navbar-light fixed-top bg-primary w-100 " style="opacity: 0.9;">
                ...
                <nav class="navbar">
                    <a class="navbar-brand" href="/ProgettoHR/Home/${businessUnit}"> <img
                            src="/ProgettoHR/img/Erre_technology_group_NEW.png" style="width: 170px;">
                    </a>
                </nav>
    ...
    <div style="margin-top: 110px;" class="container-fluid">
        <div class="row">
            <div class="col-1.5" style="opacity: 0.9; border-radius: 0px 10px 10px 0px; background-color: #0466c8;">
                ...
                <a href="/ProgettoHR/Candidati/${businessUnit}" type="button"
                    ...
                    style="background-color: #0353a4; border-color: transparent; border-radius: 1px 10px 10px 1px;"><i
                        class="fas fa-plus-square mr-1"></i> Candidato <i class="fas fa-user "></i></a>
                ...
                <c:choose>
                    <c:when test="${ ruolo == 'admin'}">
                        <button class="btn btn-dark btn-block mt-1 text-left"
                            ...
                            <i class="fas fa-plus-square mr-1"></i> Mansione <i class="fas fa-briefcase "></i>
                        </button>
                    </c:when>
                </c:choose>
            ...
            <div class="col-10">
                ...
                <div class="row">
                    ...
                    <!-- COLONNA 1 CON FILTRI -->
                    <div class="col-auto mb-2">
                        <form action="/ProgettoHR/Home/filter/${businessUnit}" method="post">
                            <div class="form-row">

                                <!-- FILTRO CON STATO DEL CANDIDATO-->
                                <div class="col-auto">
                                    <div class="input-group">

                                        <select onchange="validateOption()" class="custom-select" id="stati"
                                            name="stato">
                                ...
                                <div class="col-auto">
                                    <div class="input-group">
                                        ...
                                        <select onchange="validateOption()" class="custom-select" id="stati"
                                            ...
                                            <option selected disabled>Business Unit</option>
