...
<body
	...
	<div style="margin-top: 110px;" class="container-fluid ">
		<div class="row ">
			...
			<!-- Modal AGGIUNTA FILE -->
			<div class="modal fade" id="allegatiModal" tabindex="-1"
				role="dialog" aria-labelledby="modificaModalLabel"
				aria-hidden="true">
										...
										<div class="col w-100 p-0 justify-content-md-start">
											<div class="form-group">
												...
												<input type="text" class="form-control" id="nome"
													name="nome" value="${mostraCandidato.nome}"></input>
											</div>
										</div>
									</div>
									<div class="row w-100 p-2 m-0 justify-content-md-start">
										...
										<div class="col w-100 p-0 justify-content-md-start">
											<div class="form-group">
												...
												<input type="text" class="form-control" id="anno"
													name="anno" value="${mostraCandidato.anno}"></input>
											</div>
										</div>
									</div>
									<div class="row w-100 p-2 m-0 justify-content-md-start">
										...
										<div class="col w-100 p-0 justify-content-md-start">
											<div class="form-group">
												...
												<input type="text" class="form-control"
													id="specializzazione" name="specializzazione"
