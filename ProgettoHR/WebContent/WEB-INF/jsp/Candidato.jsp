...
<body
    ...
    <div style="margin-top: 110px;" class="container-fluid ">
        <div class="row ">
            <div class="col-1.5"
                    ...
                    <c:choose>
                        <c:when test="${funz.funzionalita == 'aggiunta mansione'}">
                            <button data-toggle="modal" data-target="#aggiungiMansione" type="button"
                                ...
                                <i class="fas fa-plus-square mr-1"></i> Mansione <i class="fas fa-briefcase"
                ...
                <c:forEach var="funz" items="${ruolo.funzionalita}">
                    <c:choose>
                        <c:when test="${funz.funzionalita == 'aggiunta qualification meeting'}">
                            <button type="button" data-toggle="modal" data-target="#modificaFeedbackModal"
                                class="btn btn-dark btn-block  mt-1 text-left"
                                style="background-color: #0353a4; border-color: transparent; border-radius: 1px 10px 10px 1px;">
                                <i class="fas fa-plus-square"></i> Qualification meeting <i class="fas fa-brain"></i>
                            </button>
                        </c:when>
                    </c:choose>
                </c:forEach>
                    ...
                    <c:choose>
                        <c:when test="${funz.funzionalita == 'aggiunta economics'}">
                            <button type="button" data-toggle="modal" data-target="#modificaFeedbackModal"
                                class="btn btn-dark btn-block  mt-1 text-left"
                                style="background-color: #0353a4; border-color: transparent; border-radius: 1px 10px 10px 1px;">
                                <i class="fas fa-plus-square"></i> Economics<i class="fas fa-coins pl-1"></i>
                            </button>
                        </c:when>
                    </c:choose>
                </c:forEach>
                    ...
                    <c:choose>
                        <c:when test="${funz.funzionalita == 'aggiunta costi'}">
                            <button type="button" data-toggle="modal" data-target="#modificaFeedbackModal"
                                class="btn btn-dark btn-block  mt-1 text-left"
                                style="background-color: #0353a4; border-color: transparent; border-radius: 1px 10px 10px 1px;">
                                <i class="fas fa-plus-square"></i> Costi<i class="fas fa-euro-sign pl-1"></i>
                            </button>
                        </c:when>
                    </c:choose>
                </c:forEach>
                            ...
                            <div>
                                ...
                                <div class="dropdown-menu"
                                    ...
                                    <button onclick="impostaTipoFeedback('Mail')" type="button" data-toggle="modal"
                                        data-target="#feedbackModal" class="btn btn-success btn-block mt-1 text-left"
                                        style="background-color: #03045e; border-color: transparent; border-radius: 10px 10px 10px 10px;">
                                        <i class="fas fa-plus-square mr-1"></i> E-mail <i
                                            class="fas fa-envelope-open-text pl-1" style="vertical-align: auto;"></i>
                                    </button>

                                    <button onclick="impostaTipoFeedback('Social')" type="button" data-toggle="modal"
                                        data-target="#feedbackModal" class="btn btn-success btn-block mt-1 text-left"
                                        style="background-color: #03045e; border-color: transparent; border-radius: 10px 10px 10px 10px;">
                                        <i class="fas fa-plus-square mr-1"></i> Social network <i
                                            class="fas fa-comment-dots pl-1" style="vertical-align: auto;"></i>
                                    </button>
                                    ...
                                    <button onclick="impostaTipoFeedback('Telefonata')" type="button"
                                        ...
                                        style="background-color: #03045e; border-color: transparent; border-radius: 10px 10px 10px 10px;">
                                        <i class="fas fa-plus-square mr-1"></i> Telefonata <i class="fas fa-phone pl-1"
                                            style="vertical-align: auto;"></i>
                                    </button>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <table class="table table-bordered text-left shadow p-4 ml-2 mb-4 bg-white">
                            <tbody>
                                <tr>
                                    <th colspan=2 class="text-center table-info" style="background-color: #90e0ef">
                                        ANAGRAFICA
                                        <c:forEach var="funz" items="${ruolo.funzionalita}">
                                            <c:choose>
                                        ...
                                        <c:when test="${funz.funzionalita == 'modifica anagrafica'}">
                                            <tr>
                                                ...
                                                <td scope="col"><button class="btn btn-primary dropdown-toggle"
                                                        role="button" id="menuStato" data-toggle="dropdown"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th colspan=2 class="text-center table-success"
                                                    style="background-color: #77bfa3">
                                                    BUSINESS <c:forEach var="funz" items="${ruolo.funzionalita}">
                                                        <c:choose>
                                                            <c:when
                    ...
                    <div class="col-12">
                            ...
                            <thead>
                                ...
                                <tr>
                                    <th colspan=5 class="text-center table-success" style="background-color: #fca311">
                                        ...
                                        <c:forEach var="funz" items="${ruolo.funzionalita}">
                                            <c:choose>
                                                <c:when test="${funz.funzionalita == 'modifica qualification meeting'}">
                                                    <button type="button" data-toggle="modal"
                        ...
                        <table class="table table-bordered text-left shadow p-4 ml-2 mb-4 bg-white" id="feedbackTable">
                            <thead>
                                ...
                                <tr>
                                    <th colspan=3 class="text-center table-secondary" style="background-color: #e7d8c9">
                                        FEEDBACK
                                        ...
                                        <tbody>
                                            <c:forEach var="allegato" items="${mostraCandidato.file}">
                                                <tr>
                                                    ...
                                                    <td>${allegato.tipo}</td>
                                                    <td><a href="<c:url value='/download/${mostraCandidato.id}/${allegato.id}' />"
                                                            class="btn btn-success custom-width">Scarica</a></td>
                                                    <td><a href="<c:url value='/delete/${mostraCandidato.id}/${allegato.id}' />"
    ...
    <div class="modal fade" id="modificaBusinessModal" tabindex="-1" role="dialog" aria-labelledby="modificaModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="modificaEconomicsModal" tabindex="-1" role="dialog" aria-labelledby="modificaModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                            ...
                            <div class="row w-100 p-2 m-0 justify-content-md-start">
                                <div class="col w-100 p-0 justify-content-md-start">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="Inquadramento" name="Inquadramento"
                                            value="${economics.inquadramento}"></input>
                                    </div>
                                </div>
                            </div>
                            <div class="row w-100 p-2 m-0 justify-content-md-start">
                            ...
                            <div class="row w-100 p-2 m-0 justify-content-md-start">
                                <div class="col w-100 p-0 justify-content-md-start">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="desiderata" name="desiderata"
                                            value="${economics.desiderata}"></input>
                                    </div>
                                </div>
                            </div>
                            <div class="row w-100 p-2 m-0 justify-content-md-start">
    ...
    <div class="modal fade" id="modificaCostiModal" tabindex="-1" role="dialog" aria-labelledby="modificaModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="aggiungiMansione" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
