...
public class CostoGiornalieroMaxFilter extends CandidatoFilter {
	@Override
	public List<Predicate> checkFilter(List<Predicate> listaPredicati, Root<Candidato> root, String nomeFiltro,
			String valore) {

		if (nomeFiltro.contains("costoGiornalieroMax")) {
			...
			listaPredicati.add(criteriaBuilder.lessThanOrEqualTo(costo.get("giornaliero"), Integer.parseInt(valore)));
