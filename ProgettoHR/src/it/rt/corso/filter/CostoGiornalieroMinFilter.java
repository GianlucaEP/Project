...
public class CostoGiornalieroMinFilter extends CandidatoFilter {
	@Override
	public List<Predicate> checkFilter(List<Predicate> listaPredicati, Root<Candidato> root, String nomeFiltro,
			String valore) {

		if (nomeFiltro.contains("costoGiornalieroMin")) {
			...
			listaPredicati.add(criteriaBuilder.greaterThanOrEqualTo(costo.get("giornaliero"), Integer.parseInt(valore)));
